...
# Replace common LineageOS spellings in property values without touching paths or /etc.
...
# Product identity used by Android and Setup Wizard-facing APIs.
...
if grep -qi 'lineage[[:space:]_-]*os' "$PROP"; then
